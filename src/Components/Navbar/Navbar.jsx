    ...
    <div className='fixed top-3 inset-x-0 bg-white mx-auto w-[90%] flex justify-between items-center px-5 py-4 font-bold rounded-lg shadow-lg shadow-gray-600 font-serif'>
        ...
        <div className='w-1/3 text-lg font-semibold '>
            <ul className='w-full flex justify-around items-center'>
                <li className='nav-content inline-block relative'><NavLink to="/">Home</NavLink></li>
                <li className='nav-content inline-block relative'><NavLink to="/Attraction">Attraction</NavLink></li>
                <li className='nav-content inline-block relative'><NavLink to="/Events">Events</NavLink></li>
