...
function Login() {
  ...
  return (
    <div className="min-h-[70vh] mt-24 mb-5 w-full flex justify-center items-center">
      <form className="w-1/3 flex flex-col justify-center items-center shadow-lg shadow-gray-700 py-10 px-8" onSubmit={(e)=>Login(e)}>
        ...
        <div className="w-full flex justify-center items-center text-3xl">
          <button className="mr-4" onClick={LoginWithGoogle}><FontAwesomeIcon icon={faGoogle} /></button>
